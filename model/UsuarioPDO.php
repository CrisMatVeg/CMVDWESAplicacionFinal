...
class UsuarioPDO {
    ...
    public static function validarUsuario($codUsuario, $password=null) {
        ...
        if (!$objetoResultado) return null;
        ...
        return new Usuario(
            ...
            $objetoResultado['T01_FechaHoraUltimaConexionAnterior'] ?? null
        );
    }
    ...
    public function actualizarUltimaConexionYUsuario($usuario) {
        ...
        $usuario->setFechaHoraUltimaConexion($resultado['T01_FechaHoraUltimaConexion']);
    }
    ...
    public static function altaUsuario($codUsuario, $password, $descUsuario) {
        ...
        if ($consulta->rowCount() === 0) return null;
    ...
    public static function editarUsuario($codUsuario, array $datosNuevos) {
        ...
        $sql = "UPDATE T01_Usuarios SET " . implode(', ', $campos) . " WHERE T01_CodUsuario = :usuario";
    ...
    public static function guardarToken($codUsuario, $token) {
        $sql = "UPDATE T01_Usuarios SET T01_TokenApi = :token WHERE T01_CodUsuario = :codUsuario";
    ...
    public static function buscarUsuarios($descripcion=null) {
        ...
        foreach ($usuarios as $usuario) {
            $usuariosListado[] = new Usuario(
                ...
                $usuario['T01_FechaHoraUltimaConexionAnterior'] ?? null
            );
        }
